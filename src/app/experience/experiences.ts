export const personalInfo = {
  ...
  languages: [
    { name: "English", level: 90 }, // level is 0-100 for progress bar
    { name: "Nepali", level: 100 },
    { name: "Hindi", level: 70 }
  ],
  hobbies: ["Reading", "Running", "Photography", "Stargazing"],
  education: [
    {
...
export const experiencesData = [
  {
    ...
    location: "REMOTE",
    description: [
      "Investigated unsolved design cases involving paranormal phenomena.",
      "Utilized ATS for case file management and layout optimization."
    ]
  },
  {
    ...
    location: "KATHMANDU, NEPAL",
    description: [
      "Designed high-quality print materials for 50+ corporate events.",
      "Implemented design systems for retail brand growth."
    ]
  }
];
