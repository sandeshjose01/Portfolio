...
export const recommendations: Recommendation[] = [
  {
    ...
    image: "",
    text: "I had the opportunity to work closely with Sandesh Joshi... Sandesh demonstrated strong proficiency in Adobe Creative Cloud tools, particularly Illustrator and Photoshop..."
  }
];
