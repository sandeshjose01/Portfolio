...
// Official ArtStation "A" Logo
const ArtStationIcon = () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 17.723l2.033 3.504h11.233l-5.632-9.723L0 17.723zm24-1.127L17.207 5.012l-2.825 4.887 4.01 6.945H24v-.248zM15.427 19.345L9.584 9.24 6.744 14.128l5.844 10.102h5.684l-2.845-4.885z"/>
    </svg>
);

// Official Behance "Be" Logo (Upper B, small e)
const BehanceIcon = () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M8.228 15.01h-2.182V8.99h2.016c1.887 0 2.503.953 2.503 1.956 0 .825-.398 1.543-1.282 1.832.996.223 1.543 1.054 1.543 2.12 0 1.297-.847 2.112-2.6 2.112zm-2.182-4.116h1.777c.88 0 1.265-.312 1.265-.968 0-.742-.481-.984-1.297-.984H6.046v1.952zm0 3.14h2.121c.969 0 1.488-.34 1.488-1.078 0-.82-.558-1.121-1.503-1.121H6.046v2.2zM16.593 15.195c-2.433 0-3.953-1.637-3.953-3.703 0-2.11 1.523-3.66 3.906-3.66 2.348 0 3.707 1.445 3.707 3.527v.473h-5.594c.059 1.137.817 1.879 1.977 1.879 1.066 0 1.586-.473 1.879-1.008h1.961c-.485 1.516-1.832 2.492-3.883 2.492zm1.902-4.73c-.059-.875-.719-1.422-1.742-1.422-1.055 0-1.77.547-1.922 1.422h3.664zM14.07 6.438h5.051v1.176H14.07V6.438z"/>
    </svg>
);
